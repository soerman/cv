...
\fancypagestyle{otherpages}{
    \fancyhead[R]{\textcolor{cvmargincolor}{Marvin Noll}}
    \fancyhead[L]{\textcolor{cvmargincolor}{Curriculum vit\ae}}
}
...
\cvsection{ADDITIONAL INFORMATION}\vspace{\cvbetweensectionandheadingextraskipamount}
\cvitem{\cvheadingstyle{Driving licence}}{
    Class B (Germany)
}

\cvitem{\cvheadingstyle{Voluntary work}}{
	\\[-5.5ex]\begin{itemize}[leftmargin=*]
	        \item University student group ``KIT-car''
