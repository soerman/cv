...
\cvsection{EDUCATION}
\cvitem{\cvdurationstyle{2018 -- 2021}}{\cvtitle{M. Sc. Electrical Engineering and Information Technologies}
    Karlsruhe Institute of Technology
    \begin{itemize}[leftmargin=*]
        \item Specialising in adaptronics
        \item Master thesis \textit{A Terabit Sampling System with a Photonics Time-Stretch ADC} (at KIT-IPE, grade: 1.3)
...
\cvitem{\cvdurationstyle{April 2022 -- present}}{\cvtitle{Doctoral Researcher}
	Institute for Data Processing and Electronics (IPE) at KIT
	\begin{itemize}[leftmargin=*]
		\item Preliminary thesis title: \textit{Development of the Data Acquisition System for the PANDA Micro Vertex Detector}
	\end{itemize}
}


\cvitem{\cvdurationstyle{September 2021 -- March 2022}}{\cvtitle{Student Assistant}
	Institute for Data Processing and Electronics (IPE) at KIT
	\begin{itemize}[leftmargin=*]
		\item Development of firmware on FPGA for terabit sampling system
	\end{itemize}
}

\cvitem{\cvdurationstyle{May 2017 -- June 2021}}{\cvtitle{Student Assistant}
...
\cvitem{\cvheadingstyle{Computer skills}}{
    \\[-5.5ex]\begin{itemize}[leftmargin=*]
    	\item Programming: Python, MATLAB, Vivado
    	\item CAS: Maple
    	\item CAD: Mentor Graphics PADS
...
\cvitem{\cvdurationstyle{}}{\cvtitle{German Life Saving Association (DLRG)}
	Local Branch Durlach
	\begin{itemize}[leftmargin=*]
		\item Swimming trainer for children and life-saving
		\item Lifeguard
	\end{itemize}
}
\cvitem{\cvdurationstyle{}}{\cvtitle{Federal Agency for Technical Relief (THW)}
	Local Branch Karlsruhe
	\begin{itemize}[leftmargin=*]
		\item Assistant in Technical Unit Debris Clearance
	\end{itemize}
}
\end{document}
